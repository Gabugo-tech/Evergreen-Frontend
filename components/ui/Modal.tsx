            ...
            {(title || showClose) && (
              <div className="flex items-start justify-between p-6 pb-4">
                ...
                {showClose && (
                  <button
                    onClick={onClose}
                    className="ml-4 flex-shrink-0 p-1.5 rounded-lg text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 hover:bg-slate-100 dark:hover:bg-dark-muted transition-colors"
